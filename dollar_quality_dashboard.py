...
with tab3:
    ...
    links = [
        ...
        ("🌏 EMB 신흥국채권 ETF",   "https://www.investing.com/etfs/ishares-jpmorgan-usd-em-mkts-bd"),
        ("🌍 EEM 신흥국주식 ETF",   "https://www.investing.com/etfs/ishares-msci-emg-markets"),
        ("🇰🇷 한국 3M 금리 (SMBS)","http://www.smbs.biz/Bond/BondMajor.jsp"),
        ("💵 달러인덱스 무역가중",    "https://fred.stlouisfed.org/series/DTWEXBGS"),
        ("📉 하이일드 스프레드",      "https://fred.stlouisfed.org/series/BAMLH0A0HYM2"),
    ]
