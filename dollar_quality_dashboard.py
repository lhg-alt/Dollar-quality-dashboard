...
# Plotly 공통 레이아웃 — 모든 텍스트 색상을 진하게 명시
PLOTLY_LIGHT = dict(
...
AXIS_STYLE = dict(
    ...
    titlefont=dict(color="#1a202c", size=12),
    gridcolor="#e2e8f0",
    linecolor="#cbd5e1",
    showgrid=True,
)
...
with tab1:
    ...
    fig.update_layout(
        **PLOTLY_LIGHT,
        ...
        yaxis=dict(**AXIS_STYLE, showgrid=True, title="정규화 값 (0~100)"),
        legend=dict(
    ...
    with col_result:
        ...
        fig_bar.update_layout(
            **PLOTLY_LIGHT,
            ...
            yaxis=dict(**AXIS_STYLE, title="스왑 포인트 (원)"),
            margin=dict(t=50, b=30, l=10, r=10),
            showlegend=False,
        )
        # 막대 위 숫자 텍스트도 진하게
